...
public class PlayerMotionAxisCond extends AbstractCond {
    ...
    public boolean isTrue(EntityPlayer player, World worldIn, IAmbienceSource sourceIn) {
        ...
        switch (axis) {
            case X: return test.testForDouble(player.posX - player.prevPosX, value);
            case Y: return test.testForDouble(player.posY - player.prevPosY, value);
            case Z: return test.testForDouble(player.posZ - player.prevPosZ, value);
        }
