...
public class CondsUtil {
    ...
    public enum CondList {
        ...
        PLAYER_DIMENSION(110, new PlayerDimensionCond(AmbienceEquality.EQUAL_TO, Level.OVERWORLD.getRegistryName().toString())),
        PLAYER_STRUCTURE(111, new PlayerStructureCond(AmbienceEquality.EQUAL_TO, StructureFeature.MINESHAFT.getFeatureName(), 0D, false)),
