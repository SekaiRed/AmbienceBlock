...
public class StringListWidget extends Widget {
    ...
    private void drawElementString(MatrixStack matrix, int index) {
        int color = 0xFFFFFF;
        ...
        font.drawStringWithShadow(matrix, list.get(index), getElementX() + separation, getElementY(index) + getyFontOffset(), color);
    }
