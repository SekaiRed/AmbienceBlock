...
public class MusicTab extends AbstractTab {
    ...
    public TextField introName = new TextField(font, getNeighbourX(textIntroName), getRowY(0), getEndX() - getNeighbourX(textIntroName) - 20 - horizontalSeparation, 20, new TextComponentString(""));
    public Button introButton = new Button(getNeighbourX(introName), getRowY(0) + getOffsetY(20), 20, 20, new TextComponentString("..."), button -> {
        Minecraft.getMinecraft().displayGuiScreen(new ChooseSoundGUI(this.screen, introName));
    });
    ...
    public TextField outroName = new TextField(font, getNeighbourX(textOutroName), getRowY(1), getEndX() - getNeighbourX(textOutroName) - 20 - horizontalSeparation, 20, new TextComponentString(""));
    public Button outroButton = new Button(getNeighbourX(outroName), getRowY(1) + getOffsetY(20), 20, 20, new TextComponentString("..."), button -> {
        Minecraft.getMinecraft().displayGuiScreen(new ChooseSoundGUI(this.screen, outroName));
    });
    ...
    */
    ...
    public void initialInit() {
        ...
        addWidget(textIntroName);
        addWidget(introName);
        addWidget(introButton);

        outroName.setMaxStringLength(50);
        addWidget(textOutroName);
        addWidget(outroName);
        addWidget(outroButton);
        //addButton(copy);
        //addButton(paste);
    ...
    public void updateWidgetPosition() {
        ...
        introName.x = getNeighbourX(textIntroName); introName.y = getRowY(0); introName.width = getEndX() - getNeighbourX(textIntroName) - 20 - horizontalSeparation;
        ...
        outroName.x = getNeighbourX(textOutroName); outroName.y = getRowY(1); outroName.width = getEndX() - getNeighbourX(textOutroName) - 20 - horizontalSeparation;
