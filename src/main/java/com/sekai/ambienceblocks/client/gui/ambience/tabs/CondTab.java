...
public class CondTab extends AbstractTab {
    ...
    //widgets
    Button edit = new Button(0, 0, 30, 20, "Edit", button -> {
        buttonEdit();
    });
    Button add = new Button(0, 0, 30, 20, "Add", button -> {
        buttonAdd();
    });
    Button remove = new Button(0, 0, 30, 20, "Del", button -> {
        buttonRemove();
    });
    Button up = new Button(0, 0, 30, 20, "Up", button -> {
        buttonUp();
    });
    Button down = new Button(0, 0, 30, 20, "Down", button -> {
        buttonDown();
    });
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        edit.render(mouseX, mouseY,partialTicks);
        ...
        condGuiList.render(mouseX, mouseY);
    }
