...
public class CheckboxWidget extends CheckboxButton {
    ...
    public void renderButton(int p_renderButton_1_, int p_renderButton_2_, float p_renderButton_3_) {
        ...
        blit(this.x, this.y, 0.0F, super.isChecked() ? 20.0F : 0.0F, 20, this.height, 32, 64);
        this.renderBg(minecraft, p_renderButton_1_, p_renderButton_2_);
        this.drawString(fontrenderer, this.getMessage(), this.x + 24, this.y + (this.height - 8) / 2, 0xFFFFFF);
    }
