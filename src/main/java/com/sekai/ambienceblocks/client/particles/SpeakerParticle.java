...
public class SpeakerParticle extends TextureSheetParticle {
    SpeakerParticle(ClientLevel level, double x, double y, double z, ItemLike item) {
        super(level, x, y, z);
    ...
    public static class SpeakerProvider implements ParticleProvider<SimpleParticleType> {
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new SpeakerParticle(level, x, y, z, RegistryHandler.INVISIBLE_AMBIENCE_BLOCK_ITEM.get());
        }
    }
}
